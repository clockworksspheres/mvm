...
from mvm.lib.run_commands import (
    NotACyLoggerError,
...
# from mvm.lib.loggers import CyLogger, MockLogger, LogPriority as lp

from mvm.lib.loggers import MockLogger as CyLogger
...
class TestCommunicate(unittest.TestCase):
    ...
    @patch("mvm.lib.run_commands.Popen")
...
class TestTimeoutMethod(unittest.TestCase):
    ...
    @patch("mvm.lib.run_commands.threading.Timer")
    @patch("mvm.lib.run_commands.Popen")
...
class TestRunWithSudoSubprocess(unittest.TestCase):
    ...
    @patch("mvm.lib.run_commands.os.set_blocking")
    @patch("mvm.lib.run_commands.select.select", return_value=([], [], []))
    @patch("mvm.lib.run_commands.subprocess.Popen")
    ...
    @patch("mvm.lib.run_commands.os.set_blocking")
    @patch("mvm.lib.run_commands.select.select")
    @patch("mvm.lib.run_commands.subprocess.Popen")
...
class TestRunMyThreadCommand(unittest.TestCase):
    ...
    @patch("mvm.lib.run_commands.RunThread")
