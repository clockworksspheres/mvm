...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # -------------------------------
        # QShortcut backups (macOS-safe)
        # -------------------------------
        QShortcut(QKeySequence.ZoomIn, self, activated=self.console.zoom_in)
        QShortcut(QKeySequence.ZoomOut, self, activated=self.console.zoom_out)
