...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        act_zoom_in.setShortcut(QKeySequence(Qt.CTRL | Qt.Key_Equal))
        ...
        act_zoom_out.setShortcut(QKeySequence(Qt.CTRL | Qt.Key_Minus))
        ...
        act_reset.setShortcut(QKeySequence(Qt.CTRL | Qt.Key_0))
        ...
        act_clear.setShortcut(QKeySequence(Qt.CTRL | Qt.Key_L))
