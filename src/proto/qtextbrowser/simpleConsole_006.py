...
# ---------------------------------------------------------
# GUI mode with menu bar + shortcuts
# ---------------------------------------------------------
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Menu bar (use QMainWindow's built-in one)
        menubar = self.menuBar()
        # On macOS, keep it in the window instead of global bar
        ...
        # Also install shortcuts explicitly (some platforms ignore QAction shortcuts)
        QShortcut(QKeySequence("Ctrl++"), self, activated=self.console.zoom_in)
        QShortcut(QKeySequence("Ctrl+="), self, activated=self.console.zoom_in)  # mac quirk
        QShortcut(QKeySequence("Ctrl+-"), self, activated=self.console.zoom_out)
        QShortcut(QKeySequence("Ctrl+0"), self, activated=self.console.reset_zoom)
        QShortcut(QKeySequence("Ctrl+L"), self, activated=self.console.clear_console)
